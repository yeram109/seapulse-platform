...
/* ---------------------------------------------------------
   홈 KPI — 제거됨 (2026-07-16)

   물류/어업인은 GET /predictions, 관리자는 GET /admin/model + /admin/pipeline 으로
   대체했다. 관리자 KPI 의 '모델 MAE ±1,240원 · 어획량 ±1.2톤'은 실제 모델
   (±1,740원/kg · ±9.9톤)과 달라서 그대로 두면 성능을 과장하는 값이었다.
   사용자 수(128명)만 여전히 근거가 없어 state.demoUserCount 로 옮겼다.
--------------------------------------------------------- */
