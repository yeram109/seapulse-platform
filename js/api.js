...
// 기본 http://localhost:8000. 다른 호스트로 붙이려면 index.html 등에서
// window.SEAPULSE_API = 'http://...' 를 먼저 지정하면 그 값을 쓴다.
const BASE = (typeof window !== 'undefined' && window.SEAPULSE_API) || 'http://localhost:8000';
